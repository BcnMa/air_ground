...
enum SystemState
{
    ...
    State_Pause = 10, //暂停
    State_Continue = 11, //继续
    State_Pausing = 12, //暫停中
    
};

const std::vector<std::string> StateName = {"State_Idle", "State_Drive", "State_Reverse",
                    "State_Stop", "State_SwitchToDrive", "State_SwitchToReverse",
                    "State_ForceExternControl", "State_OfflineDebug", "Task Complete", "Task Preempt", "State_Pause", "State_Continue"};
} // end namespace flags
