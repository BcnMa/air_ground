...
#ifndef __exlcm_Object_hpp__
#define __exlcm_Object_hpp__
...
int Object::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int Object::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int Object::getEncodedSize() const
{
...
int Object::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __int8_t_encode_array(buf, offset + pos, maxlen - pos, &this->label, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int Object::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __int8_t_decode_array(buf, offset + pos, maxlen - pos, &this->label, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int Object::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t Object::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x9b140d910f90c9b3LL;
